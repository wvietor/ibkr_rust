...
pub trait Remote: wrapper::Remote {
    #[inline]
    fn tick_price_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send { async move {
        decode_fields!(
        fields =>
            req_id @ 2: i64,
            tick_type @ 0: u16,
    ...
    #[inline]
    fn tick_size_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send { async move {
        decode_fields!(
            fields =>
                req_id @ 2: i64,
                tick_type @ 0: u16,
    ...
    #[inline]
    fn order_status_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send { async move {
        println!("{:?}", &fields);
        Ok(())
    } }
    ...
    #[inline]
    // todo: Implement a proper Error Enum
    fn err_msg_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send { async move {
        decode_fields!(
            fields =>
                req_id @ 2: i64,
                error_code @ 0: i64,
    ...
    #[inline]
    fn open_order_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send { async move {
        decode_fields!(
            fields =>
                order_id @ 1: i64,
                contract_id @ 0: ContractId,
    ...
    #[inline]
    fn acct_value_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send { async move {
        decode_fields!(
            fields =>
                name @ 2: String,
                value @ 0: String,
    ...
    #[inline]
    fn portfolio_value_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send { async move {
        decode_fields!(
            fields =>
                contract_id @ 2: ContractId,
                position @ 10: f64,
    ...
    #[inline]
    fn acct_update_time_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send { async move {
        decode_fields!(
            fields =>
                timestamp @ 2: String
        );
    ...
    fn next_valid_id_msg(
        ...
        tx: &mut Tx,
        rx: &mut Rx,
    ) -> impl Future<Output=anyhow::Result<()>> + Send { async move {
        Ok(())
    } }
    ...
    #[inline]
    fn execution_data_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send { async move {
        println!("{:?}", &fields);
        Ok(())
    }}

    #[inline]
    fn market_depth_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send { async move {
        decode_fields!(
            fields =>
                req_id @ 1: i64,
                position @ 0: u64,
    ...
    #[inline]
    fn market_depth_l2_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send { async move {
        decode_fields!(
            fields =>
                req_id @ 2: i64,
                position  @ 0: u64,
    ...
    #[inline]
    fn news_bulletins_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn receive_fa_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn historical_data_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            decode_fields!(
        fields =>
            req_id @ 1: i64,
    ...
    #[inline]
    fn scanner_data_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn tick_generic_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            decode_fields!(
        fields =>
            req_id @ 2: i64,
    ...
    #[inline]
    fn tick_string_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            decode_fields!(
        fields =>
            req_id @ 2: i64,
    ...
    #[inline]
    fn tick_efp_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            unimplemented!();
        }
    }
    ...
    #[inline]
    fn current_time_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            decode_fields!(
        fields =>
            req_id @ 1: i64,
    ...
    #[inline]
    fn real_time_bars_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            decode_fields!(
        fields =>
            req_id @ 2: i64,
    ...
    #[inline]
    fn fundamental_data_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn contract_data_end_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            decode_fields!(fields => req_id @ 2: i64);
            wrapper.contract_data_end(req_id).await;
            Ok(())
    ...
    #[inline]
    fn open_order_end_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            wrapper.open_order_end().await;
            Ok(())
        }
    ...
    #[inline]
    fn acct_download_end_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            decode_fields!(
        fields => account_number @ 2: String
    );
    ...
    #[inline]
    fn tick_snapshot_end_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn market_data_type_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            decode_fields!(
        fields =>
            req_id @ 2: i64,
    ...
    #[inline]
    fn commission_report_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn position_data_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            decode_fields!(
        fields =>
            account_number @ 2: String,
    ...
    #[inline]
    fn position_end_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            wrapper.position_end().await;
            Ok(())
        }
    ...
    #[inline]
    fn account_summary_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            decode_fields!(
        fields =>
            req_id @ 2: i64,
    ...
    #[inline]
    fn verify_completed_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn position_multi_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn soft_dollar_tiers_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn family_codes_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn symbol_samples_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn tick_req_params_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            decode_fields!(
        fields =>
            req_id @ 1: i64,
    ...
    #[inline]
    fn smart_components_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn news_article_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn tick_news_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn news_providers_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn historical_news_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn head_timestamp_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            decode_fields!(
        fields =>
            req_id @ 1: i64,
    ...
    #[inline]
    fn histogram_data_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            decode_fields!(
        fields =>
            req_id @ 1: i64,
    ...
    #[inline]
    fn market_rule_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn pnl_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            decode_fields!(
        fields =>
            req_id @ 1: i64,
    ...
    #[inline]
    fn pnl_single_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            decode_fields!(
        fields =>
            req_id @ 1: i64,
    ...
    #[inline]
    fn tick_by_tick_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            decode_fields!(
        fields =>
            req_id @ 1: i64,
    ...
    #[inline]
    fn order_bound_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn completed_order_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn replace_fa_end_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn wsh_meta_data_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn wsh_event_data_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
    ...
    #[inline]
    fn user_info_msg(fields: &mut Fields, wrapper: &mut Self) -> impl Future<Output=anyhow::Result<()>> + Send {
        async move {
            println!("{:?}", &fields);
            Ok(())
        }
