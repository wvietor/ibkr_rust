...
use crate::{
    ...
    order::TimeInForce,
    wrapper::indicators::{LocalMarker, Wrapper},
};
use crate::wrapper::Local;
...
// todo: Implement a proper Error Enum
    ...
    #[inline]
    pub async fn scanner_parameters_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    pub async fn open_order_end_msg(fields: &mut Fields, wrapper: &mut W) -> anyhow::Result<()> {
    ...
    #[inline]
    pub async fn delta_neutral_validation_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    pub async fn account_summary_end_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        decode_fields!(
    ...
    #[inline]
    pub async fn verify_message_api_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    pub async fn display_group_list_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    pub async fn display_group_updated_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    pub async fn verify_and_auth_message_api_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    pub async fn verify_and_auth_completed_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    pub async fn position_multi_end_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    pub async fn account_update_multi_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    pub async fn account_update_multi_end_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    pub async fn security_definition_option_parameter_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    pub async fn security_definition_option_parameter_end_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    pub async fn historical_news_end_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    pub async fn reroute_mkt_data_req_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    pub async fn reroute_mkt_depth_req_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    pub async fn completed_orders_end_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    pub async fn historical_schedule_msg(
        fields: &mut Fields,
        wrapper: &mut W,
    ) -> anyhow::Result<()> {
        println!("{:?}", &fields);
    ...
    #[inline]
    async fn decode_generic_tick_msg(
        req_id: i64,
        tick_type: u16,
        value: f64,
        wrapper: &mut W,
